 ...
 */
//==============================================================
public class DeleteGenEdAreaView extends View {
    ...
    //----------------------------------------------------------
    public DeleteGenEdAreaView(IModel aCoord) {

        super(aCoord, "DeleteGenEdAreaView");
    ...
    protected VBox createFormContents() {
        ...
        Text prompt = new Text("Are you sure you want to delete this Gen Ed Area?");
