...
public class SearchReflectionQuestionView extends View {
    ...
    {
        return "Enter Reflection Question Search Criteria: ";
    ...
    public VBox createFormContent()
    {
        ...
        cancelButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            myModel.stateChangeRequest("CancelSearchQuestion", null);
        });
